...
public class CrazyLibs implements PluginLoader {
    ...
    public void classloader(@NotNull PluginClasspathBuilder classpathBuilder) {
        ...
        // Other
        resolver.addDependency(new Dependency(new DefaultArtifact("com.ryderbelserion.cluster.paper:cluster-api:4.1.2"), null));
        ...
        resolver.addRepository(new RemoteRepository.Builder("crazycrew-api", "default", "https://repo.crazycrew.us/releases").build());
